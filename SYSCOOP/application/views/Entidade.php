		...
		<form action="<?php echo site_url('entidade/cadastrar')?>" method="post" style="width: 100%; margin-top: 30px;">
			<div style="width:48%; float:left;">
				<div >
					...
					<input type="text" name="cnpj" id="cnpj" class="form-control" autocomplete="off" value="<?php echo set_value('cnpj')?>">
				</div>
				<div>
					<label form="nomeFantasia">Nome Fantasia</label>
					<?php echo form_error('nomeFantasia'); ?>
					<input type="text" name="nomeFantasia" id="nomeFantasia" class="form-control" autocomplete="off" value="<?php echo set_value('nomeFantasia')?>">
				</div>
				<div>
