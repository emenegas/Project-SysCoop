		...
		<div class="form-row">
			...
			<div class="col-md-4 mb-3">
				...
				<div class="input-group">
					...
					<input type="text" class="form-control" id="email" name="email" placeholder="email@exemplo.com" aria-describedby="inputGroupPrepend"  value="<?php echo $agricultor->email; ?>" required>
					<div class="invalid-feedback">
